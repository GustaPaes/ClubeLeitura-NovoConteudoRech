...
namespace ClubeLeitura.ConsoleApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            TelaCadastroAmigos telaCadastroAmigos = new TelaCadastroAmigos();
            telaCadastroAmigos.amigos = new Amigos[10];
            telaCadastroAmigos.notificador = new Notificador();
            ...
            {                
                ...
                if (opcaoMenuPrincipal == "3")
                {
                    ...
                    {
                        telaCadastroAmigos.EditarAmigos();
                    }
                    else if (opcao == "3")
                    {
                        telaCadastroAmigos.ExcluirAmigos();
                    }
                    else if (opcao == "4")
                    {
                        telaCadastroAmigos.VisualizarAmigos("Tela");
                        Console.ReadLine();
                    }
                }
            }
